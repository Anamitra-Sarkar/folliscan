...
- [x] Correct the frontend deployment workflow’s duplicated `frontend/frontend` working-directory error and verify the path-filtered GitHub deployment workflow succeeds.
